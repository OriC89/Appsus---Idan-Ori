export function Colors({noteId, onChangeColor}) {
    return(
        <section className={`colors colors-${noteId}`}>
            ...
            <button onClick={()=>{onChangeColor('#FF1493')}} style={{backgroundColor: '#FF1493'}}></button>
            <button onClick={()=>{onChangeColor('#663399')}} style={{backgroundColor: '#663399'}}></button>
            <button onClick={()=>{onChangeColor('#FF4500')}} style={{backgroundColor: '#FF4500'}}></button>
        </section>
        )
}